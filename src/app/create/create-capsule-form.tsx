...
export function CreateCapsuleForm() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast({
      ...
      description: `Your time capsule "${values.title}" is now sealed and will be delivered on ${format(values.openDate, "PPP")}.`,
    });
    form.reset();
    setAiSuggestion(null);
  }
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Your Message for the Future</FormLabel>
                  <FormControl>
                    <Textarea
